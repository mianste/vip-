...
class VIPVideoApp:
    def __init__(self, root):
        ...
        self.root.geometry('480x250')  # 增加窗口高度以容纳更多按钮
        self.create_widgets()
    ...
    def create_widgets(self):
        ...
        button_movie4 = tkinter.Button(self.root, text='bilibili', command=self.open_bili)
        ...
        button_movie.place(x=125, y=140, width=230, height=40)

        # 提示标签
        text = '提示：本案例仅供学习使用，不可作为他用。'
        lab_remind = tkinter.Label(self.root, text=text, fg='red', font=('Arial', 15, 'bold'))
        lab_remind.place(x=50, y=200, width=400, height=30)
